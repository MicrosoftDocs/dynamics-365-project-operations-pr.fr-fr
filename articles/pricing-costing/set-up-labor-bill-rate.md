...
description: Cet article fournit des informations sur la manière de configurer des taux de facturation de la main-d’œuvre dans Project Operations.
author: rumant
ms.date: 04/07/2021
ms.topic: article
