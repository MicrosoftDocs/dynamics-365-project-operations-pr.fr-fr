...
description: Cet article fournit des informations sur la manière de configurer des taux pour le coût de la main-d’œuvre dans Project Operations
author: rumant
ms.date: 10/12/2020
ms.topic: article
...
ms.locfileid: "8924243"
---
# <a name="set-up-labor-cost-rates"></a>Configurer les taux de coûts de la main-d’œuvre
...
| Société d’allocation de ressources | Onglet **Général** et pages **Création rapide** | Sélectionnez l’entité juridique à laquelle le rôle est affecté. Par exemple, un développeur de Fabrikam Inde ou un développeur de Fabrikam États-Unis. | La société d’allocation de ressources sur l’estimation ou les chiffres réels entrants sera mise en correspondance avec cette ligne pour établir le taux de coût par défaut du rôle. |
