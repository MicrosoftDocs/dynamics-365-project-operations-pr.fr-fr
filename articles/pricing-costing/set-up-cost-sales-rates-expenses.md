...
description: Cet article fournit des informations sur la configuration des taux de coût et de vente pour les catégories de transaction et de dépense.
author: rumant
ms.date: 04/07/2021
ms.topic: article
