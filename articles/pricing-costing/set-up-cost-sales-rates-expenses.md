...
2. Dans **Prix de catégorie** , dans le menu de la sous-grille, sélectionnez **+ Nouveau prix de catégorie**. 
...
Lorsque ce mode de tarification est sélectionné sur la ligne de prix de catégorie qui est liée à un tarif de vente, le prix est défini par défaut pour la combinaison de catégorie et d'unité uniquement pour les chiffres réels. Par exemple, les chiffres réels de ventes non facturés pour la classe de transaction de dépenses. Le prix unitaire est défini sur les chiffres réels de ventes non facturées à partir du prix unitaire sur les chiffres réels du coût de cette dépense. La définition du prix par défaut basé sur le coût n'est pas effectuée sur les estimations de projet pour les dépenses ou sur les détails de la ligne de devis et de la ligne de contrat pour les dépenses.
