...
description: Cet article fournit des détails sur le traitement des factures destinées aux clients avec Project Operations pour les scénarios basés sur les ressources/non stockés.
author: sigitac
ms.date: 04/12/2021
ms.topic: article
