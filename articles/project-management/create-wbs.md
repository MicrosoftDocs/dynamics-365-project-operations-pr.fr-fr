...
description: Cet article explique comment créer une structure de répartition du travail (WBS) incluant les contrôles de base dans la nouvelle interface de planification.
author: ruhercul
ms.date: 12/16/2021
ms.topic: article
