...
| **Société d’allocation de ressources** | Défini par défaut à partir d’un chiffre réel source. Un champ en lecture seule qui verrouillé pour modification. | Le champ est modifiable dans un nouveau détail de ligne de facture qui n’est pas associé à une chiffre réel source. |
