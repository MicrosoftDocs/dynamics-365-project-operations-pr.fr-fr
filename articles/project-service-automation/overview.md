...
Vous recherchez des ressources pour vous aider à planifier votre implémentation ? Consultez les guides téléchargeables suivants.
 ...
 [Guide de planification et de suivi de projets](../project-service/implementation-guides/project-planning-tracking.md)

 [Guide de base de devis, de tarification et de facturation](../project-service/implementation-guides/begin-quoting-pricing-billing.md)

 [Guide avancé de devis, de tarification et de facturation](../project-service/implementation-guides/adv-quoting-pricing-billing.md)

 [Guide de gestion des ressources](../project-service/implementation-guides/resource-management-guide.md)

 [Guide de création de rapports](../project-service/implementation-guides/reporting-guide.md)

 [Notes pour les développeurs](../project-service/developer-guides/overview-dev-notes-v3.x.md)
...
## <a name="guidance-for-earlier-versions-app-version-2x-or-1x"></a>Instructions pour les versions antérieures (version 2.x ou 1.x de l'application)
 ...
 [Guide du gestionnaire de compte](../project-service/account-manager-guide.md)

 [Temps, dépenses et collaboration](../project-service/time-expense-collaboration-guide.md)

 [Livres blancs (version 2.x ou 1.x de l'application)](../project-service/white-papers.md)

 [Notes pour les développeurs (version de l'application 2.x)](../project-service/developer-guides/add-custom-qoi-forms-v2.x.md)
