...
## <a name="using-journals-to-record-costs"></a>Utilisation des journaux pour enregistrer les coûts

Dans PSA, les journaux vous permettent d'enregistrer les coûts ou les revenus dans les classes de transaction des matériaux, frais, durée, dépenses ou taxes. Un journal comporte un en-tête, des lignes, puis une action **Confirmer**. Voici quelques scénarios où vous pourriez utiliser un journal :
