...
description: Cet article explique comment le concept d’origine des transactions est utilisé pour associer les chiffres réels aux enregistrements source d’origine, tels que les journaux d’entrées de temps, de dépenses ou d’utilisation de matériel.
author: rumant
ms.date: 03/25/2021
ms.topic: article
ms.prod: ''
