...
description: Cet article explique comment créer des conditions de Paiement si payé afin de pouvoir libérer des paiements partiels des fournisseurs, en fonction des paiements des clients.
author: RadhikaRS
ms.date: 03/30/2020
ms.topic: article
ms.prod: ''
