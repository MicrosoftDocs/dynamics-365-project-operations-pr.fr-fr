...
description: Cet article fournit des informations relatives à Dynamics 365 Project Service Automation dans la solution d’intégration Dynamics 365 Finance.
author: ruhercul
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
