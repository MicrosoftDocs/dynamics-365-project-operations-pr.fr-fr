...
description: Cet article fournit des informations sur la configuration des informations de rôle sur les modèles de structure de répartition du travail.
author: Yowelle
ms.date: 09/01/2020
ms.topic: article
ms.prod: ''
