...
description: Cet article répertorie les fonctionnalités et les correctifs disponibles dans la mise à jour de Project Service Automation version 25, V3.
author: ruhercul
...
Cet article répertorie les fonctionnalités et les correctifs qui sont nouveaux ou modifiés pour Project Service Automation V3, mise à jour de la version 25. Cette version porte le numéro de build V3.10.43.76 et est généralement disponible via une mise à jour automatique en octobre 2020.
