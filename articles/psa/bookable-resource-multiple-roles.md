...
description: Cet article fournit des informations sur la manière dont les dimensions de tarification peuvent être utilisées pour prendre en charge la tarification et les coûts d’une ressource qui remplit plusieurs rôles dans un projet.
author: rumant
ms.custom:
