...
description: Cette rubrique explique comment enregistrer les lignes de facture fournisseur pour les coûts de temps que les sous-traitants ont mis en place.
author: rumant
ms.date: 03/15/2022
ms.topic: article
