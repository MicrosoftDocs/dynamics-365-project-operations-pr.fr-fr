...
description: Cet article fournit des informations sur la manière de configurer une planification de provision dans Project Operations.
author: rumant
ms.date: 10/22/2020
ms.topic: article
