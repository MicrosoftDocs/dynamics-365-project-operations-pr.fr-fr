...
---
# <a name="configuring-chargeable-components-of-a-project-based-contract-line"></a>Configuration des composants facturables d’une ligne de contrat basée sur un projet
...
Le type de facturation d'une tâche peut être configuré dans l'onglet **Tâches payantes** d'une ligne de contrat en mettant à jour le champ **Type de facturation** dans la sous-grille Tâches de la ligne de contrat. Vous pouvez également mettre à jour le champ **Type de facturation** de la sous-grille de la configuration de la facturation des tâches d'un projet qui affiche les lignes de contrat associées à une tâche.
